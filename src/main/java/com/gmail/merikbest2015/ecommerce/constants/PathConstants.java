...
public class PathConstants {
    ...
    public static final String DELETE_BY_PERFUME_ID = "/delete/{productId}";
    ...
    public static final String PERFUME_ID = "/{productId}";
    public static final String IDS = "/ids";
    public static final String SEARCH = "/search";
    public static final String SEARCH_GENDER = SEARCH + "/gender";
    public static final String SEARCH_PERFUMER = SEARCH + "/productr";
    ...
    public static final String GRAPHQL_PERFUME = GRAPHQL + "/product";
}
