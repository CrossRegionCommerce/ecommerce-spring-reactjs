                ...
                <Col span={5}>
                    ...
                    {isAdmin ? (
                        <>
                            ...
                            <AccountLink link={ACCOUNT_ADMIN_PERFUMES} title={"List of products"} />
                ...
                <Col span={19}>
                    ...
                    {isAdmin ? (
                        <>
                            ...
                            <Route exact path={ACCOUNT_ADMIN_PERFUMES} component={ProductList} />
                            <Route exact path={`${ACCOUNT_ADMIN_PERFUMES}/:id`} component={EditProduct} />
